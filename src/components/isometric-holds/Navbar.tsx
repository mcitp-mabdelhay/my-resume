...
import { Download, Menu, X, Shield, Sparkles, ArrowLeft } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        {/* Action Button & Back to Portfolio */}
        <div className="hidden sm:flex items-center gap-3">
          <Link
            to="/"
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold text-gray-300 hover:text-white bg-gray-900/80 hover:bg-gray-800 border border-gray-800 transition-all"
        ...
        <div className="md:hidden bg-gray-950/95 border-b border-gray-800 px-4 pt-3 pb-6 space-y-3 backdrop-blur-xl">
          ...
          <div className="pt-2 flex flex-col gap-2">
            <Link
              to="/"
              onClick={() => setMobileMenuOpen(false)}
              className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl text-sm font-semibold text-gray-200 bg-gray-900 border border-gray-800"
            >
              <ArrowLeft size={16} />
