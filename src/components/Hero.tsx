...
export default function Hero() {
  return (
    <section id="hero" className="snap-start scroll-mt-20 pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto min-h-[80vh] flex flex-col justify-center">
      <motion.div
      ...
      >
        ...
        <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 font-light mb-8 leading-relaxed">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <a href="#contact" className="px-6 py-3 bg-black dark:bg-white text-white dark:text-black rounded-full font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors flex items-center gap-2 shadow-sm">
            <Mail size={18} />
            Get in touch
          </a>
          ...
          <div className="flex items-center gap-4 ml-2 sm:ml-4 mt-4 sm:mt-0">
            <a href="https://github.com/mma1979" target="_blank" rel="noreferrer" className="p-2 text-gray-500 hover:text-black dark:hover:text-white transition-colors">
              <Github size={24} />
            </a>
